...
public class TeleporterTempleFeature extends StructureFeature<DefaultFeatureConfig> {

    public TeleporterTempleFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
    ...
    public static class Start extends StructureStart<DefaultFeatureConfig> {
        ...
        public void init(DynamicRegistryManager registryManager, ChunkGenerator chunkGenerator, StructureManager manager, int chunkX,
            ...
            TeleporterTempleGenerator.addPieces(manager, pos, rotation, this.children);
